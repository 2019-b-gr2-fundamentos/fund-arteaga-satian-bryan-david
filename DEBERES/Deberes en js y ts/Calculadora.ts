...
const ElegirOpcionString = prompt("Suma: 1.\nResta: 2.\nMultiflicación: 3.\nDivisión: 4.\nPotencia de un número: 5.\nChoose now: ");
...
if(union){
    ...
    const ValorUno = Number(ValorUnoString);
    const ValorDos = Number(ValorDosString);
    ...
    switch(ElegirOpcion){
        ...
        case 1:
            ...
            console.log("El resultado es: "); console.log(ValorUno+ValorDos);
            break;
        ...
        case 4:
            console.log("Has elegido la División: ");
                ...
                if(ValorDos == 0){ 
                    ...
                    console.log(ValorUno); console.log(" / "); console.log(ValorDos);
                    console.log("El resultado es: "); console.log(ValorUno/ValorDos);
                }
            break;
        ...
        case 5:
            ...
            console.log(ValorUno + "^" + ValorDos);
            console.log("El resultado es: "); console.log(Math.pow(ValorUno,ValorDos));
            break;
